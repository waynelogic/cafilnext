        ...
        <div class="container grid lg:grid-cols-2 gap-10 lg:gap-20 py-12">
            <div>
                ...
                <div class="prose-lg prose-ul:p-0 prose-p:mb-3 prose-p:mt-0">
                    ...
                    <p>ООО «ФиЛнекст» — это организация, основным видом деятельности которой является деятельность по возврату просроченной задолженности.</p>
            ...
            <div class="relative max-lg:h-64">
                <x-image class="absolute w-full h-full object-center object-cover rounded-3xl shadow-card" src="images/home/about-mage.jpg" w="632" h="528" alt="О компании"></x-image>
            </div>
        </div>
    </section>
